        ...
        <div class="col-md">
            ...
            <form action="/komik/update/<?= $komik['id']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="judul" class="col-md col-form-label">Judul</label>
                    <div class="col-sm-10">
                        <input type="text"
                ...
                <div class="form-group row">
                    <label for="penulis" class="col-md col-form-label">Penulis</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="penerbit" class="col-md col-form-label">Penerbit</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="sampul" class="col-md-2 col-form-label">Sampul</label>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-8">
                        <div class="custom-file">
                            <input type="file"
                                ...
                                id="sampul" name="sampul" onchange="imgPreview()">
                            <div class="invalid-feedback">
